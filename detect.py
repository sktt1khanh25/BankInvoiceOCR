...
def run(
        weights= 'E:/yolov5/runs/train/exp2/weights/best.pt',  # model path or triton URL
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default= 'E:/yolov5/runs/train/exp2/weights/best.pt', help='model path or triton URL')
